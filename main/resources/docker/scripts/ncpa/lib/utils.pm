...
# $Id: utils.pm,v 1.1 2009/11/13 02:05:34 andrew Exp $
#
# $Log: utils.pm,v $
# Revision 1.1  2009/11/13 02:05:34  andrew
# support files, not actually needed.
#
# Revision 1.1  2006/05/02 15:55:24  andrew
# This utils.pm is from the nagios plugins project, I just have it here for ease of development.
#
...
$PATH_TO_NTPDATE = "/usr/local/sbin/ntpdate" ;
$PATH_TO_NTPDC   = "/usr/local/sbin/ntpdc" ;
$PATH_TO_NTPQ    = "/usr/local/sbin/ntpq" ;
$PATH_TO_LMSTAT  = "" ;
